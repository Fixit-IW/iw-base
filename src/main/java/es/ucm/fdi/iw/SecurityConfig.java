...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
        		.antMatchers("/static/**", "/logout", "/403", "/home","/contact","/sendMessage","/offerList","/technicianList" , "/", "/t", "/searchOffers","/register/**", "/offer/**", "/technician/**","/photo/offer/**","/admin/photo/**").permitAll()
