		...
		<div class="row justify-content-center">
			<div class="col-md-10 col-md-offset-5">
				...
				<ul class="list-group">
					...
					<li class="list-group-item"><label>Address</label><span>Kansas
							City, Missouri</span></li>
					...
					<div class="resume-section">
						...
						<ul class="date">
							...
							<li>
								<div class="date-box">
									<h4>
										Creative Design Mind<span class="date-range">2012 -
											2013</span>
									</h4>
				...
				<fieldset>
					<div class="form-group" id="connect">
						<form action="" id="connectform">
							<p>
								<label for="name">Name</label> <input class="input form-control"
									type="text" name="name" placeholder="Name" >
							</p>
							<p>
								<label for="email">Email</label> <input class="form-control"
									type="email" name="email" class="input">
							</p>
							<p>
